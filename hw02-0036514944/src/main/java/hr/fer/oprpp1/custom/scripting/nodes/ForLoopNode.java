...
public class ForLoopNode extends Node {
    ...
    /**
     * Constructor for ForLoopNode. First 3 arguments aren't optional, but the 4th one is optional.
     ...
     * @param stepExpression step expresssion of for loop.
     */
    public ForLoopNode(ElementVariable variable, Element startExpression, Element endExpression, Element stepExpression) {
        // First 3 arguments can't be null
    ...
    /**
     * toString method for ForLoopNode. It prints in format such that if read again by a parser, it would result
     * in the same ForLoopNode structure.
