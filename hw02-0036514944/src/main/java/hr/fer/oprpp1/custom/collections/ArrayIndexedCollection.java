...
public class ArrayIndexedCollection implements List {
    ...
    public ArrayIndexedCollection(Collection other, int initialCapacity) {
        ...
        elements = new Object[biggerInitialCapacity];
    ...
    public void add(Object value) {
        ...
        Object[] reallocatedElements = new Object[2 * elements.length];
    ...
    public Object[] toArray() {
        ...
        if (size >= 0) System.arraycopy(elements, 0, array, 0, size);
    ...
    private static class ArrayIndexedCollectionElementsGetter implements ElementsGetter {
        ...
        private final ArrayIndexedCollection collectionReference;
        private int currentElementIndex = 0;
        private final long savedModificationCount;

        public ArrayIndexedCollectionElementsGetter(ArrayIndexedCollection collectionReference, long savedModificationCount) {
