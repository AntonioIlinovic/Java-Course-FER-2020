...
public interface Collection {
    ...
    /**
     * Method calls <code>processor.process(.)</code> for each element of this {@link Collection}. The order in which elements
     * will be sent is defined by {@link ElementsGetter}.
     *
    ...
    /**
     * Method adds into the current {@link Collection} all elements from the given collection. This other {@link Collection} remains
     * unchanged.
     *
    ...
    /**
     * Object returns new ElementGetter which can fetch and return elements from Collection depending on implementation.
     *
    ...
    /**
     * Add all elements from given {@link Collection} that satisfy {@link Tester} method to the current {@link Collection}.
     *
